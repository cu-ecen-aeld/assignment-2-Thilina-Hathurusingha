...
void test_validate_my_username()
{
    ...
    const char *name_fun = my_username();
    
    const char *name_conf = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(name_fun,name_conf, "AESD students, please fix me!");
}
